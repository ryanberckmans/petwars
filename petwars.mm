...
/alias {createpet %3} {/itemadd {petwars2} {@Word($3,1)};makepet @Word($3,1);setgodmode $3} {Petwars}
...
/variable {whoison} {[1m[33mPlayer         Pet Level
[1m[36mErich          [35m20
[1m[36mKhaoric        [35m11} {}
